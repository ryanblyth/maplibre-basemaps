...
export function createPlaceLabelLayers(theme: Theme): LayerSpecification[] {
  ...
  return [
    // Continent labels
    { id: "continent-label", type: "symbol", source: "world_low", "source-layer": "place", minzoom: 0, maxzoom: 6.5, filter: ["all", ["==", ["get", "class"], "continent"], ["<=", ["zoom"], 2.5], ["!=", ["coalesce", ["get", "name:en"], ["get", "name"]], "America"]], layout: { "text-field": ["case", ["==", ["coalesce", ["get", "name:en"], ["get", "name"]], "North America"], "NORTH\nAMERICA", ["==", ["coalesce", ["get", "name:en"], ["get", "name"]], "South America"], "SOUTH\nAMERICA", ["upcase", ["coalesce", ["get", "name:en"], ["get", "name"]]]], "text-font": theme.fonts.regular, "text-size": ["interpolate", ["linear"], ["zoom"], 0, 12, 2.5, 16], "text-transform": "none", "text-letter-spacing": 0.1, "text-offset": ["case", ["==", ["coalesce", ["get", "name:en"], ["get", "name"]], "North America"], ["literal", [2.0, 4.0]], ["==", ["coalesce", ["get", "name:en"], ["get", "name"]], "South America"], ["literal", [0, -2.0]], ["literal", [0, 0]]] }, paint: { ...placeLabelPaint, "text-opacity": 0.75 } },
    
    // Country labels (world_low)
    { id: "country-label-world", type: "symbol", source: "world_low", "source-layer": "place", minzoom: 0, maxzoom: 6.5, filter: ["all", ["==", ["get", "class"], "country"], [">", ["zoom"], 2.5]], layout: { "text-field": createAbbreviatedTextField(), "text-font": theme.fonts.regular, "text-size": ["interpolate", ["linear"], ["zoom"], 2.5, 10, 3, 12, 6, 16], "text-transform": "uppercase", "text-letter-spacing": 0.1 }, paint: { ...placeLabelPaint, "text-opacity": 0.75 } },
    
    // Country labels (world_mid)
    { id: "country-label-world-mid", type: "symbol", source: "world_mid", "source-layer": "place", minzoom: 6, filter: ["all", ["==", ["get", "class"], "country"], [">", ["zoom"], 2.5]], layout: { "text-field": createAbbreviatedTextField(), "text-font": theme.fonts.regular, "text-size": ["interpolate", ["linear"], ["zoom"], 6, 16, 10, 20], "text-transform": "uppercase", "text-letter-spacing": 0.1 }, paint: { ...placeLabelPaint, "text-opacity": 0.75 } },
    
    // Country labels (us_high)
    { id: "country-label", type: "symbol", source: "us_high", "source-layer": "place", minzoom: 6, filter: ["==", ["get", "class"], "country"], layout: { "text-field": createAbbreviatedTextField(), "text-font": theme.fonts.regular, "text-size": ["interpolate", ["linear"], ["zoom"], 2, 12, 6, 18, 10, 24], "text-transform": "uppercase", "text-letter-spacing": 0.1 }, paint: { ...placeLabelPaint, "text-opacity": 0.75 } },
    
    // State labels (US states filter for world_low)
    { id: "state-label-us-world", type: "symbol", source: "world_low", "source-layer": "place", minzoom: 3.33, maxzoom: 6.5, filter: ["all", ["==", ["get", "class"], "state"], usStatesFilter], layout: { "text-field": createStateTextField(), "text-font": theme.fonts.regular, "text-size": ["interpolate", ["linear"], ["zoom"], 3.33, 8, 6, 12], "text-transform": "none", "text-letter-spacing": 0.05 }, paint: { ...placeLabelPaint, "text-opacity": 0.5 } },
    
    // State labels (us_high)
    { id: "state-label-us", type: "symbol", source: "us_high", "source-layer": "place", minzoom: 4, filter: ["==", ["get", "class"], "state"], layout: { "text-field": createStateTextField(), "text-font": theme.fonts.regular, "text-size": ["interpolate", ["linear"], ["zoom"], 4, 8, 8, 16, 12, 18], "text-transform": "none", "text-letter-spacing": 0.05 }, paint: { ...placeLabelPaint, "text-opacity": 0.5 } },
    
    // City labels - rank 1-2 (world)
    { id: "city-label-world-rank1-2", type: "symbol", source: "world_low", "source-layer": "place", minzoom: 1, maxzoom: 6.5, filter: ["all", ["==", ["get", "class"], "city"], ["<=", ["coalesce", ["get", "rank"], 10], 2]], layout: { "text-field": createAbbreviatedTextField(), "text-font": theme.fonts.regular, "text-size": ["interpolate", ["linear"], ["zoom"], 1, ["case", ["==", ["coalesce", ["get", "rank"], 1], 1], 10.8, 9], 3, ["case", ["==", ["coalesce", ["get", "rank"], 1], 1], 14.4, 12], 6, ["case", ["==", ["coalesce", ["get", "rank"], 1], 1], 16.8, 14]], "text-transform": "none", "text-letter-spacing": 0.05 }, paint: { ...placeLabelPaintThin, "text-opacity": 0.75 } },
    
    // City labels - rank 1-2 (us_high)
    { id: "city-label-us-rank1-2", type: "symbol", source: "us_high", "source-layer": "place", minzoom: 4, filter: ["all", ["==", ["get", "class"], "city"], ["<=", ["coalesce", ["get", "rank"], 10], 2]], layout: { "text-field": createAbbreviatedTextField(), "text-font": theme.fonts.regular, "text-size": ["interpolate", ["linear"], ["zoom"], 4, ["case", ["==", ["coalesce", ["get", "rank"], 1], 1], 15, 12], 8, ["case", ["==", ["coalesce", ["get", "rank"], 1], 1], 25, 20], 12, ["case", ["==", ["coalesce", ["get", "rank"], 1], 1], 32, 26]], "text-transform": "none", "text-letter-spacing": 0.05 }, paint: { ...placeLabelPaintThin, "text-opacity": 0.75 } },
    
    // All places (towns, villages) - us_high
    { id: "city-label-us-all", type: "symbol", source: "us_high", "source-layer": "place", minzoom: 8, filter: ["all", ["match", ["get", "class"], ["city", "town", "village", "hamlet"], true, false], ["case", ["==", ["get", "class"], "village"], ["case", ["has", "rank"], ["<=", ["get", "rank"], 10], true], true]], layout: { "text-field": createAbbreviatedTextField(), "text-font": theme.fonts.regular, "text-size": createPlaceSizeExpression(), "text-transform": "none", "text-letter-spacing": 0.05 }, paint: { ...placeLabelPaintThin, "text-opacity": 0.6 } },
  ];
}
