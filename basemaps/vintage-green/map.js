...
/**
 * Vintage Green Basemap - Map Initialization
 * 
 ...
 * 
 *   import { createVintageGreenStyle } from './styles/vintageGreenStyle.js';
 *   
 *   const map = new maplibregl.Map({
 *     container: "map-container",
 *     style: createVintageGreenStyle(),
 *     // ... other options
 *   });
 * 
...
// These values match basemaps/vintage-green/styles/theme.ts vintageGreenSettings
...
const map = new maplibregl.Map({
  container: "map-container",
  style: "./style.json",
  center: center,  // From theme.ts vintageGreenSettings.view.center
  zoom: zoom,  // From theme.ts vintageGreenSettings.view.zoom
  pitch: pitch,  // From theme.ts vintageGreenSettings.view.pitch
  bearing: bearing,  // From theme.ts vintageGreenSettings.view.bearing
  minZoom: minZoom,  // From theme.ts vintageGreenSettings.minZoom
  maxZoom: 22,
  hash: false,
